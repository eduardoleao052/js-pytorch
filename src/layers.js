const { assureArray, getShape } = require('./utils.js');
const jstorch = require('./tensor.js')
...
class Embedding extends Module {
    ...
    constructor(in_size, embed_size) {
        super()
        this.E = jstorch.randn([in_size, embed_size], true, true);
    };
...
class PositionalEmbedding extends Module {
    ...
    constructor (n_timesteps, embed_size) {
        super()
        this.E = jstorch.randn([n_timesteps, embed_size], true, true);
    };
